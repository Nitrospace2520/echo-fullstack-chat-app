...
const SignUpPage = () => {
  ...
  // note: this function is called when the form is submitted
  ...
  // note: this function is validating the form data
  const validateForm = () => {
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center justify-center gap-2 group">
              <div className="size-12 rounded-xl bg-primary/10 flex justify-center items-center group-hover:bg-primary/20 transition-colors">
                <MessageSquare className="size-6 text-primary group-hover:text-primary-dark transition-colors" />
              </div>
